...
import BusAvailability from "../BusAvailability/BusCard";
  ...
  return (
    <div className="map-container">
      ...
      <div className="card-container">
        <Card
          title="Reducing Train Emissions"
          content="Trains are a major mode of transportation with relatively low CO2 emissions compared to other forms of travel. We're committed to making train travel even more sustainable by investing in cleaner energy sources and reducing our carbon footprint."
          icon="train"
        ...
        <Card
          title="Green Flying Initiatives"
          content="We understand the environmental impact of air travel. Our goal is to make air travel more sustainable by researching and implementing eco-friendly technologies, using renewable fuels, and optimizing flight routes to reduce CO2 emissions."
          icon="flight"
        ...
        <Card
          title="Eco-Friendly Bus Transportation"
          content="Buses play a crucial role in public transportation. We're dedicated to improving the sustainability of bus services by transitioning to electric and hybrid buses, promoting public transit usage, and minimizing emissions in urban areas."
          icon="bus"
        ...
        <>
          <div>
            <img
              src={img}
              alt="train"
              style={{ witdth: "2000px", height: "500px" }}
            />
          </div>
